...
describe('clearPanel', function () {
    it("is clears the panel", function () {
        expect(Game.Rules.clearPanel).not.toBeUndefined();
    });
});

describe('resetGame', function () {
    it("is restoring the init settings", function () {
        expect(Game.Rules.resetGame).not.toBeUndefined();
    });
});
